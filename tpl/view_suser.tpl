	<div class="page-header"><h1>Connect User details</h1></div>
	   ...
	   <table class="table table-condensed">
	     <tbody>
<?php $cols = $obj->printCols(); $arr = $obj->toArray(); foreach($cols as $k => $v) { ?>
	      <tr><td><?php echo $k; ?></td><td><?php echo $arr[$v]; ?></td></tr>
<?php } ?>
	     </tbody>
	   </table>
	  </div>
            ...
            <ul class="nav nav-pills nav-stacked">
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li><a href="/del/w/suser/i/<?php echo $obj->id; ?>">Delete</a></li>
                  <li><a href="/edit/w/suser/i/<?php echo $obj->id; ?>">Edit</a></li>
                </ul>
              </li>
            </ul>
          </div>
