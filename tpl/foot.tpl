...
?>
      <footer class="col-md-offset-1">&copy; 2012-2017 <a href="http://espix.net">Espix Network SPRL</a> - <a href="https://github.com/tgouverneur/SPXOps/wiki">SPXOps</a> v<?php echo Config::$version; ?><?php echo $dur_time; ?></footer>
    </div> <!-- /container -->
