<?php
if (!isset($obj) || !$obj) { $obj = new SGroup(); }
...
?>
	  ...
	  <h1><?php echo $action; ?> a Server Group</h1>
	</div>
        <form method="POST" action="/<?php echo strtolower($action); ?>/w/sgroup<?php if ($edit) echo "/i/".$obj->id; ?>" class="form-horizontal">
